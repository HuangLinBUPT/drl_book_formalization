...
**更新时间**: 2026-04-06（习题 2.8.3.3 完成，习题 2.8 系列全部完成）
...
| 2.8.3.1 | O(d) 投影最优性条件（Part 3a）：$(Q^\top X)^\top=Q^\top X$ 且 $Q^\top X \succeq 0$ | ✅ 完成 | 0 |
| 2.8.3.2 | O(d) 矩阵平方根刻画（Part 3b）：$Q^\top X = (X^\top X)^{1/2}$ | ✅ 完成 | 0 |
| 2.8.3.3 | O(d) SVD 投影结论（Part 3c）：$UV^\top = \operatorname{proj}_{O(d)}(X)$ | ✅ 完成 | 0 |

**总体进展**: 21 个练习，16 个完全完成，5 个接近完成（共 8 个 sorries 待解决）
